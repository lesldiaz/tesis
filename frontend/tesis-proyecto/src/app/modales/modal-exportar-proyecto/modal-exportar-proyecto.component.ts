...
@Component({
  selector: 'app-modal-exportar-proyecto',
  templateUrl: './modal-exportar-proyecto.component.html',
  styleUrls: ['./modal-exportar-proyecto.component.css']
})
export class ModalExportarProyectoComponent implements OnInit {
